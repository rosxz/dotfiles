...
let
  cfg = config.services.invidious2;
  ...
  localDatabaseConfig = lib.mkIf cfg.database.createLocally {
    ...
    services.invidious2.database.host = lib.mkDefault null;
